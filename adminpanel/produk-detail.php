    ...
    <div class="col-12 col-md-6 mb-5">
        <form action="" method="post" enctype="multipart/form-data">
            <div> 
                ...
                <input type="text" name="name" id="name" class="form-control mt-2" value="<?php echo $data['nama'];?>" autocomplete="off" required>
            </div>
            <div>
            ...
            <div>
                ...
                <select name="ketersediaan_stok" id="ketersediaan_stok" class="form-control mt-2">
